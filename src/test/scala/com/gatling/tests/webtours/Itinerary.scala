...
class Itinerary extends Simulation {
	...
	val scn = scenario("Itinerary")
		.exec(http("request_0")
			...
			.headers(it_headers_1), http("request_2")
			.get("/cgi-bin/itinerary.pl")
			.headers(it_headers_1), http("request_3")
			.get("/WebTours/images/home.gif")
			.headers(it_headers_3), http("request_4")
			.get("/WebTours/images/signoff.gif")
			.headers(it_headers_3), http("request_5")
			.get("/WebTours/images/cancelreservation.gif")
			.headers(it_headers_3), http("request_6")
			.get("/WebTours/images/cancelallreservations.gif")
			.headers(it_headers_3), http("request_7")
			.get("/WebTours/images/flights.gif")
			.headers(it_headers_3), http("request_8")
